...
public class PGNKPSPublicSoap12
{
    ...
    private PGNConnectionProvider connectionProvider=new PGNHttpConnectionProvider();

    public PGNKPSPublicSoap12()
    {
    }

    public PGNKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public PGNKPSPublicSoap12 (String url,PGNConnectionProvider connectionProvider) {
        this.url=url;
    ...
    protected PGNRequestResultHandler createRequestResultHandler()
    {
        PGNRequestResultHandler handler = new PGNRequestResultHandler(PGNSoapVersion.v1_2);
        return handler;
    }
    
    private org.w3c.dom.Document createTCKimlikNoDogrulaRequest(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili,PGNRequestResultHandler __handler) throws java.lang.Exception
    {
    ...
    {
        PGNRequestResultHandler __handler =createRequestResultHandler();
        ...
        org.w3c.dom.Node __result=PGNHelper.getResult(__handler.getOutputBody(), "TCKimlikNoDogrulaResult",false);
        if(__result!=null)
        {
            return PGNHelper.toBoolFromString(((org.w3c.dom.Element)__result).getTextContent());
        }
        return null;
    }
    protected void sendRequest(String soapAction,org.w3c.dom.Document soapBody, PGNRequestResultHandler handler) throws java.lang.Exception
    {
        ...
        String __requestBody=PGNHelper.getStringFromDocument(soapBody);
        if(enableLogging)
        {
            System.out.println("requestDump: "+__requestBody);
        }
        PGNResponseData response=connectionProvider.sendRequest(url,__requestBody, __headers,handler);
        if(enableLogging)
        {
