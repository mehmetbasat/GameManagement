...
public class PGNKPSPublicSoap
{
    ...
    public PGNKPSPublicSoap()
    {
    }

    public PGNKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public PGNKPSPublicSoap (String url,PGNConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        PGNRequestResultHandler handler = new PGNRequestResultHandler(PGNSoapVersion.v1_1);
        return handler;
    }
